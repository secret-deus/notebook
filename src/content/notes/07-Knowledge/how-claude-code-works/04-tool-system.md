...
| | TaskStopTool | 停止后台任务 |
| | TaskCreate/Get/Update/ListTool | 任务管理 v2（详见 [[how-claude-code-works/15-task-system|第 11 章]]） |
...
上一章：[[how-claude-code-works/03-context-engineering|上下文工程]] | 下一章：[[how-claude-code-works/09-skills-system|技能系统]]
