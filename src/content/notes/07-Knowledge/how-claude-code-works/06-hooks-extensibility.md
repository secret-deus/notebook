...
PermissionRequest Hook 参与[[how-claude-code-works/11-permission-security|权限系统的竞速机制]]——与 UI 确认对话框和 ML 分类器同时运行，先完成的获胜。
...
上一章：[[how-claude-code-works/08-memory-system|记忆系统]] | 下一章：[[how-claude-code-works/07-multi-agent|多 Agent 架构]]
