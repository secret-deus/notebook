...
2. **恢复所有已激活的技能**：预算 25K Token（每个技能限 5K Token），确保已加载的 [[how-claude-code-works/09-skills-system|技能]] 不丢失
...
上一章：[[how-claude-code-works/02-agent-loop|系统主循环]] | 下一章：[[how-claude-code-works/04-tool-system|工具系统]]
